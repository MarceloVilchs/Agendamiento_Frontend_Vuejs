        ...
        <v-col col="12" sm="6" md="6">
          ...
          <form @submit.prevent="registerAccount">
                    ...
                    <div class="form-group mt-5 text-right mx-auto">
                        ...
                        <input type="password" id="pass_confirm" v-model="formData.pass_confirm" required
                            class="elevation-1">
                    </div>
                    ...
                    <div class="form-group mt-5 text-right mx-auto">
                        ...
                        <input type="text" id="last_name" v-model="formData.last_name" placeholder="Apellido Paterno"
                            required class="elevation-1">
                    </div>

                    <div class="form-group mt-5 text-right mx-auto">
                        <label for="last_name2" class="custom-label text-left">Apellido Materno: </label>
                        <input type="text" id="last_name2" v-model="formData.last_name2" placeholder="Apellido Materno"
                            required class="elevation-1">
                    </div>
